...
public class questionlistofSingleChoiceforQuiz extends AppCompatActivity {
    ...
    private BaseAdapter singlechoiceAdapter = new BaseAdapter() {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView != null) {
                ...
                ll = (LinearLayout) LayoutInflater.from(questionlistofSingleChoiceforQuiz.this).inflate(R.layout.single_choice_sampleof_quiz, null);
            }
            ...
            if (position > 8){num.setText((position + 1) + ". ");}else {num.setText((position + 1) + ".   ");}
    ...
    public void returnarticle(){
        ...
        Intent i = new Intent(questionlistofSingleChoiceforQuiz.this, questionlistReadingComprehension.class);
        i.putExtras(b);
        i.putExtra("distinguish","fromquestionlistofquiz");
